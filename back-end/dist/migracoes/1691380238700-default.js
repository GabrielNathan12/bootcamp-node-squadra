...
exports.Default1691380238700 = void 0;
class Default1691380238700 {
    constructor() {
        this.name = 'Default1691380238700';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "TB_ENDERECO" ("CODIGO_ENDERECO" number GENERATED BY DEFAULT AS IDENTITY, "NOME_RUA" varchar2(255) NOT NULL, "NUMERO" varchar2(255) NOT NULL, "COMPLEMENTO" varchar2(255) NOT NULL, "CEP" varchar2(255) NOT NULL, "CODIGO_PESSOA" number, "CODIGO_BAIRRO" number, CONSTRAINT "PK_2006c133e7c56a888972bfccdc4" PRIMARY KEY ("CODIGO_ENDERECO"))`);
...
exports.Default1691380238700 = Default1691380238700;
